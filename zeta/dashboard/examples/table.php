	                ...
	                <div class="row"> 
	                    <div class="col-md-12">
	                        <div class="card card-plain">
	                            ...
	                            <!-- //Aqui vai o select com os dados do banco (Marco)... -->
	                             <!-- //Colocar como link para poder ser clicavel (Marco)... -->
	                              <!-- //O link devera chamar uma pagina nova para mostrar o anuncio (Marco)... -->
	                                ...
	                                <table class="table table-hover">
	                                    ...
	                                    <?php
	                                    	while($row = $query->fetch(PDO::FETCH_OBJ)){
	                                    		echo '
	                                        <tr>
	                                        	<td ><a href="update.php?p='.$row->id.'">'.$row->titulo.'</a></td>
