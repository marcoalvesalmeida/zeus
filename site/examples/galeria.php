...
<body>
	...
	<section class="galeria">
		<div class="conteudo">
			...
			<h2> Dica: Se não desejar excluir você pode adicionar mais imagens...</h2><a href="fotos_per.php?op=atualizar_fotos&zeus=<?php echo $id ?>"><button class="btn btn-primary pull-right">Adicionar</button></a></br>
			<form action="/ZEUS/site/examples" method="post">
